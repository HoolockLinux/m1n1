...
bool nvme_init(void)
{
    ...
    if (adt_is_compatible(adt, node, "iop-ans2,t8015")) {
        ...
        nvme_type = NVME_TYPE_T8103;
        nvme_queue_size = NVME_QUEUE_SIZE_T8103;
    }
    ...
    nvme_rtkit = rtkit_init_asc("nvme", nvme_asc, NULL, NULL, nvme_sart, false, NULL, NULL);
    if (!nvme_rtkit)
        goto out_sart;
